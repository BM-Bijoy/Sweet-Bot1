...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var tl = ["নয়ন আমার RAM, মেহেরাজ আমার ROM! 💻😁" , "নয়ন-এর চার্জার 🔋 আর মেহেরাজ-এর WiFi 📶 ছাড়া আমি চালুই হই না!" , "আমি আসলে মেহেরাজ-এর সিক্রেট বট আর নয়ন-এর হাসির ব্যাংক! 🤖😂" , "নয়ন আপডেট দিলেই আমি ফানি মোডে যাই! 🔄🤣" , "মেহেরাজ আমাকে বানায়, নয়ন আমাকে চালায়! 🛠️⚡" , "আমার ব্রেন = নয়ন, আমার পাওয়ার = মেহেরাজ! 🧠⚡" , "নয়ন নাম নিলেই আমার ব্যাটারি ফুল চার্জ হয়! 🔋😍" , "মেহেরাজ ছাড়া আমি Buffering... ⏳😆" , "নয়ন-এর মুডে আমি ফানি বট, মেহেরাজ-এর মুডে আমি কিউট বট! 🥰😂" , "আমি তো নয়ন মেহেরাজ এডিশন 2.0! ⚡🤖" , "মেহেরাজ-এর কফি ☕ না খেলে আমি Sleep Mode এ চলে যাই! 😴" , "নয়ন আর মেহেরাজ ছাড়া আমি আনইনস্টলড! ❌🤣" , "নয়ন আমাকে Emoji শিখায়, মেহেরাজ আমাকে Joke শিখায়! 😀" , "আমি বট না, আমি তো নয়ন-মেহেরাজ-এর ডিজিটাল পোষা! 🐶🤖" , "নয়ন আর মেহেরাজ থাকলেই আমি ভাইরাল! 🚀" ,];
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "ওই কিরে") || (event.body.toLowerCase() == "oi keray") ||(event.body.toLowerCase() == "...") || (event.body.toLowerCase() == "...")) {
     return api.sendMessage("নয়ন ভাই মধু মধু রসমালাই 🍆⛏️🐸🤣", threadID);
   };

   if ((event.body.toLowerCase() == "bot ki") || (event.body.toLowerCase() == "বট কি")) {
     return api.sendMessage("ভাই, আমি তো মেহেরাজ-এর হ্যান্ডসাম এআই ভার্সন! 😎🤖 ", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "noyon") || (event.body.toLowerCase() == "noyon bai") || (event.body.toLowerCase() == "@Maheraj Mahmud Noyon ッ") || (event.body.toLowerCase() == "নয়ন")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ NOYON ッ ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 ullash.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com/share/16v7QYTTDf/\nতার সাতে যোগা যোগ করবেন WhatsApp :- +01750***", threadID);
   };

   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator:Maheraj Mahmud Noyon ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস নয়ন আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is Noyon ッ❤️ তাকে সবাই মেহেরাজ নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "sala ami tor boss") || (event.body.toLowerCase() == "সালি আমি নয়ন") || (event.body.toLowerCase() == "cup sala ami ullash") || (event.body.toLowerCase() == "madari")) {
     return api.sendMessage("সরি বস মাফ করে দেন আর এমন ভুল হবে না🥺🙏", threadID);
   };

   if ((event.body.toLowerCase() == "@Md Istihak Oni") || (event.body.toLowerCase() == "@Md Istihak Oni ")) {
     return api.sendMessage("খবরদার কেউ এই আইড়ি মেনশন দিবানা এটা আমার বস নয়ন এর বউ এর আইড়ি😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "গ্রুপের সব মেয়ে কই") || (event.body.toLowerCase() == "arohi")) {
     return api.sendMessage("সাবধান গ্রুপের মেয়েদের খবর নিবেন না সবগুলা, আমার বস নয়নের সাথে চিপায়😠🥰⛏️", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "@MD Shiam Tafeder ") || (event.body.toLowerCase() == "সিয়াম")) {
   ...
   if ((event.body.toLowerCase() == "Bot") || (event.body.toLowerCase() == "tor nanire xudi")) {
     return api.sendMessage("️এত এত ডাকিস কেনো দেখা যাবে বাসর-রাতে-তুই-কতো পারিস..!🥱🌝🌚⛏️🌶️ ", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "ami Noyon") || (event.body.toLowerCase() == "kire")) {
